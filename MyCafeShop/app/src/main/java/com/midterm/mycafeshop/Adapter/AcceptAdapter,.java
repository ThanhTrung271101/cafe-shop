...
public class AcceptAdater extends ArrayAdapter<Order> {
    Context context;
    List<Order> orderList;
    public AcceptAdater(@NonNull Context context, List<Order>dataOrder) {
        super(context, R.layout.item_accept,dataOrder);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_accept,null,true);
